      ...
      <section id="team">
        <div class="container">
          <div class="section-header wow fadeInUp">
            ...
            <p><a href="/hello?sort_content=film&all_film=true">|<lng:tr text="All_films" locale="${lang}"></lng:tr>|</a></p>
                </c:if>
          </div>
        <c:choose>
          ...
          <div class="row">
            <c:forEach var="film" items="${films}">
              <div class="col-sm-4 wow fadeInUp">
                ...
                <div class="member-info">
                  ...
                  <a href="/session_for_film?id_film=${film.id}" class="button fit"><lng:tr text="Watch" locale="${lang}"/></a>
                  </div>
                </div>
              </div>
              </div>
            ...
            <c:if test="${all eq 'true'}">
              <c:if test="${page != 0}">
               <a href="/hello?sort_content=film&all_film=true&page=${page-1}"class="icon ion-android-arrow-back"></a>
              </c:if>
              <c:if test="${page != last}">
                <a href="/hello?sort_content=film&all_film=true&page=${page+1}"class="icon ion-android-arrow-forward"></a>
              </c:if>
            </c:if>
            </div>
          </div>
          ...
          <c:otherwise>
            ...
            <div class="col wow fadeInUp">
                <div class="member-info">
                  <div class="member-info-content">
                  <h4>${date}</h4>
                  <a href="/sessions_for_day?day_of_week=${date}" class="button fit" data-poptrox="youtube,800x400"><lng:tr text="Watch" locale="${lang}"/></a>
                </div>
              </div>
            </div>
            </c:forEach>
